...
public class RequestFragment extends Fragment {
    ...
    private void initUI() {
        ...
        edtCurrencyValue = (EditText) view.findViewById(R.id.request_value_edt_id);
        edtCurrencyQty = (EditText) view.findViewById(R.id.request_qty_edt_id);
        spnrCurrencySymbol = (Spinner) view.findViewById(R.id.request_token_spnr_id);
        spnrContactName = (Spinner) view.findViewById(R.id.request_contact_spnr_id);
        btnRequest = (Button) view.findViewById(R.id.request_btn_id);
    }
    ...
    private void clickListeners() {
        btnRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) context).showSuccessAlertDialogue(context, "Request sent successful");
    ...
    private class CurrencyTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            if (view.getId() == R.id.request_value_edt_id) {
...
*/
            ...
            } else if (view.getId() == R.id.request_qty_edt_id) {
