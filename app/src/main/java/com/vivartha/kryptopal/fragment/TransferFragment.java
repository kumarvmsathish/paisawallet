...
public class TransferFragment extends Fragment {
    ...
    private List<String> transferFromList;
    private Spinner spnrCurrencySymbol;
    private Spinner spnrTransfer;
...
//        getFromTransfer();
    ...
    private void initUI() {
        ...
        edtCurrencyValue = (EditText) view.findViewById(R.id.transfer_value_edt_id);
        edtCurrencyQty = (EditText) view.findViewById(R.id.transfer_qty_edt_id);
        spnrCurrencySymbol = (Spinner) view.findViewById(R.id.transfer_token_spnr_id);
        spnrTransfer = (Spinner) view.findViewById(R.id.transfer_from_spnr_id);
        btnTransfer = (Button) view.findViewById(R.id.transfer_btn_id);
    }


    private void getFromTransfer() {
        transferFromList = dbOperations.getContacts();
        arrayAdapter = new ArrayAdapter<>(context, android.R.layout.simple_spinner_dropdown_item, android.R.id.text1, transferFromList);
        spnrTransfer.setAdapter(arrayAdapter);
    }
    ...
    private void clickListeners() {
        btnTransfer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) context).showSuccessAlertDialogue(context, "Transferred successful");
    ...
    private class CurrencyTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            if (view.getId() == R.id.transfer_value_edt_id) {
...
*/
            ...
            } else if (view.getId() == R.id.transfer_qty_edt_id) {
