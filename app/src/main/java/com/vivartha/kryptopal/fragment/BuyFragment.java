...
public class BuyFragment extends Fragment {
    ...
    //Initialize all the UI contents where its belongs to fragment_buy
    private void initUI(View view) {
        context = getActivity();
        valuesSymbolList = new ArrayList<>();
        dbOperations = new DbOperations(context);
        spnrBanksName = (Spinner) view.findViewById(R.id.buy_banks_spnr_id);
        edtCurrencyValue = (EditText) view.findViewById(R.id.buy_value_edt_id);
        edtCurrencyQty = (EditText) view.findViewById(R.id.buy_qty_edt_id);
        spnrCurrencySymbol = (Spinner) view.findViewById(R.id.buy_token_spnr_id);
        btnBuyNow = (Button) view.findViewById(R.id.buy_btn_id);
    }
    ...
    private void clickListeners() {
        btnBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) context).showSuccessAlertDialogue(context, "Withdrawal successful");
    ...
    private class CurrencyTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            if (view.getId() == R.id.buy_value_edt_id) {
            ...
            } else if (view.getId() == R.id.buy_qty_edt_id) {
